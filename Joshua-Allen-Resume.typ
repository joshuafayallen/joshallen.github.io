#import "vantage-typst.typ": vantage, term, styled-link
...
#vantage(
  ...
  [
    ...
    #for project in configuration.projects [ 
      === #project.title _#link(project.details.link)[#project.details.format]_ - #styled-link(project.details.link)[Project Link]
  ...
  [
    ...
    #for langs in configuration.languages [
      • #langs
    ]

   == Libraries and Frameworks 
   #for libs in configuration.libraries [
    • #libs
   ]
  
  == Infrastructure 
  #for infra in configuration.infrastructure [
    • #infra
  ]
